...
// console.log(`${spaceShuttle.name} will take ${getDaysToLocation(kilometersToMars)} days to get to Mars`);
// console.log(`${spaceShuttle.name} will take ${getDaysToLocation(kilometersToTheMoon)} days to get to the moon`);
